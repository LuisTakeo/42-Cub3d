...
// raycasting - dda (digital differential analyzer) - dda (digital differential analyzer)
...
// free
void			free_map(char **map);void		calculate_dist_to_side(t_cub3d *cub3d, t_vector ray_dir);
float		calculate_dda(t_cub3d *cub3d, t_vector ray_dir);
// hooks
void		listen_moves(mlx_key_data_t keydata, void *param);
void		ft_hook(void *param);
